 ...
 */
final class Version20220514112202 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prediction ADD race_score INT DEFAULT NULL, ADD total_score INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prediction DROP race_score, DROP total_score, CHANGE time time VARCHAR(30) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
