 ...
 */
final class Version20220205112843 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prediction ADD pole TINYTEXT NOT NULL COMMENT \'(DC2Type:object)\', DROP pole_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prediction ADD pole_id INT DEFAULT NULL, DROP pole, CHANGE time time VARCHAR(30) NOT NULL COLLATE `utf8mb4_unicode_ci`');
