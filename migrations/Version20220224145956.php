 ...
 */
final class Version20220224145956 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE score ADD last_event_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE score ADD CONSTRAINT FK_32993751996AD15 FOREIGN KEY (last_event_id) REFERENCES event (id)');
        $this->addSql('CREATE INDEX IDX_32993751996AD15 ON score (last_event_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE score DROP FOREIGN KEY FK_32993751996AD15');
        $this->addSql('DROP INDEX IDX_32993751996AD15 ON score');
        $this->addSql('ALTER TABLE score DROP last_event_id, CHANGE season season VARCHAR(10) NOT NULL COLLATE `utf8mb4_unicode_ci`');
