 ...
 */
final class Version20220514085942 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prediction ADD race_created_at DATETIME DEFAULT NULL, ADD race_updated_at DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prediction DROP race_created_at, DROP race_updated_at, CHANGE time time VARCHAR(30) NOT NULL COLLATE `utf8mb4_unicode_ci`');
