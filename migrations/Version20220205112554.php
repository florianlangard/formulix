 ...
 */
final class Version20220205112554 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prediction ADD pole_id INT DEFAULT NULL, DROP pole');
        $this->addSql('ALTER TABLE prediction ADD CONSTRAINT FK_36396FC8419C3385 FOREIGN KEY (pole_id) REFERENCES driver (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_36396FC8419C3385 ON prediction (pole_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prediction DROP FOREIGN KEY FK_36396FC8419C3385');
        $this->addSql('DROP INDEX UNIQ_36396FC8419C3385 ON prediction');
        $this->addSql('ALTER TABLE prediction ADD pole TINYTEXT NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:object)\', DROP pole_id, CHANGE time time VARCHAR(30) NOT NULL COLLATE `utf8mb4_unicode_ci`');
