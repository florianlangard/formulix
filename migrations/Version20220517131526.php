 ...
 */
final class Version20220517131526 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE score ADD qualifying_score INT DEFAULT NULL, ADD race_score INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE score DROP qualifying_score, DROP race_score, CHANGE season season VARCHAR(10) NOT NULL COLLATE `utf8mb4_unicode_ci`');
