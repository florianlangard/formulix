 ...
 */
final class Version20220514085623 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prediction ADD finish_second_id INT DEFAULT NULL, ADD finish_third_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE prediction ADD CONSTRAINT FK_36396FC89444017B FOREIGN KEY (finish_second_id) REFERENCES driver (id)');
        $this->addSql('ALTER TABLE prediction ADD CONSTRAINT FK_36396FC8CD87909A FOREIGN KEY (finish_third_id) REFERENCES driver (id)');
        $this->addSql('CREATE INDEX IDX_36396FC89444017B ON prediction (finish_second_id)');
        $this->addSql('CREATE INDEX IDX_36396FC8CD87909A ON prediction (finish_third_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prediction DROP FOREIGN KEY FK_36396FC89444017B');
        $this->addSql('ALTER TABLE prediction DROP FOREIGN KEY FK_36396FC8CD87909A');
        $this->addSql('DROP INDEX IDX_36396FC89444017B ON prediction');
        $this->addSql('DROP INDEX IDX_36396FC8CD87909A ON prediction');
        $this->addSql('ALTER TABLE prediction DROP finish_second_id, DROP finish_third_id, CHANGE time time VARCHAR(30) NOT NULL COLLATE `utf8mb4_unicode_ci`');
