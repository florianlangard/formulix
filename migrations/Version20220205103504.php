 ...
 */
final class Version20220205103504 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prediction CHANGE pole pole TINYTEXT NOT NULL COMMENT \'(DC2Type:object)\'');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prediction CHANGE pole pole VARCHAR(120) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE time time VARCHAR(30) NOT NULL COLLATE `utf8mb4_unicode_ci`');
