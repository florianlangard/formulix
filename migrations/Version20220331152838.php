 ...
 */
final class Version20220331152838 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD country_code VARCHAR(2) DEFAULT NULL');
    }
