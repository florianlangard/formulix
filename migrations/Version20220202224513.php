 ...
 */
final class Version20220202224513 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE driver (id INT AUTO_INCREMENT NOT NULL, fullname VARCHAR(255) NOT NULL, number INT NOT NULL, driver_id VARCHAR(255) NOT NULL, code VARCHAR(3) NOT NULL, is_active TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
