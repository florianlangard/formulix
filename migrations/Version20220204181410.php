 ...
 */
final class Version20220204181410 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prediction ADD event_id INT NOT NULL');
        $this->addSql('ALTER TABLE prediction ADD CONSTRAINT FK_36396FC871F7E88B FOREIGN KEY (event_id) REFERENCES event (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prediction DROP FOREIGN KEY FK_36396FC871F7E88B');
        $this->addSql('DROP INDEX IDX_36396FC871F7E88B ON prediction');
        $this->addSql('ALTER TABLE prediction DROP event_id, CHANGE pole pole VARCHAR(120) NOT NULL COLLATE `utf8mb4_unicode_ci`');
