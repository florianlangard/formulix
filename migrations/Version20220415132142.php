 ...
 */
final class Version20220415132142 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD qualifying_date DATETIME DEFAULT NULL');
    }
