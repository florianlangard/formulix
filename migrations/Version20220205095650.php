 ...
 */
final class Version20220205095650 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prediction CHANGE time time VARCHAR(30) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE prediction CHANGE pole pole VARCHAR(120) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE time time DATETIME NOT NULL');
